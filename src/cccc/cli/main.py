...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_actor_add.add_argument(
        "--runtime",
        choices=["claude", "codex", "copilot", "droid", "amp", "auggie", "neovate", "gemini", "kimi", "custom"],
        default="codex",
    ...
    p_actor_update.add_argument("--runtime", choices=["claude", "codex", "copilot", "droid", "amp", "auggie", "neovate", "gemini", "kimi", "custom"], default=None, help="New runtime")
