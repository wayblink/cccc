...
from .ops.terminal_runtime_ops import try_handle_terminal_runtime_op
...
def dispatch_request(
    ...
    *,
    ...
    terminal_runtime_resp = try_handle_terminal_runtime_op(op, args)
    if terminal_runtime_resp is not None:
        return terminal_runtime_resp, False
