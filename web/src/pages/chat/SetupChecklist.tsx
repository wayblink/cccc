        ...
        >
          ...
          <div className={classNames(
            ...
            <button
              type="button"
              className={classNames(
                "flex-shrink-0 rounded-lg px-2 py-1 min-h-[36px] flex items-center text-xs font-medium border",
        ...
        >
          ...
          <button
            ...
            className={classNames(
              ...
              isCompact ? "rounded-xl px-3 py-1.5 min-h-[36px] flex items-center text-xs" : "mt-3 w-full rounded-xl px-4 py-2 text-sm"
            )}
            onClick={onAddAgent}
          >
            {t('addAgentButton')}
