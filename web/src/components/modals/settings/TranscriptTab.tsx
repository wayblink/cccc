...
export interface TranscriptPolicySectionProps {
  isDark: boolean;
  busy: boolean;
...
export interface TranscriptTailViewerProps {
  groupId?: string;
  devActors: Actor[];
  showCoordinationRoles?: boolean;
  tailActorId: string;
...
export type TranscriptTabProps = TranscriptPolicySectionProps & TranscriptTailViewerProps;

export function TranscriptPolicySection({
  busy,
...
export function TranscriptTailViewer({
  groupId,
  devActors,
  showCoordinationRoles = true,
  tailActorId,
...
export function TranscriptTab(props: TranscriptTabProps) {
  return (
    <div className="space-y-4">
      <TranscriptPolicySection {...props} />
      <TranscriptTailViewer {...props} />
    </div>
  );
}
